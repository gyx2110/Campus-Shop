$(function() {
	...
	var listUrl = '/ssm/front/listproducts';
	...
	var searchDivUrl = '/ssm/front/listshopdetailpageinfo?shopId=' + shopId;
	...
	$('.list-div').on(
			...
			function(e) {
				...
				window.location.href = '/ssm/front/productdetail?productId='
						+ productId;
			});
